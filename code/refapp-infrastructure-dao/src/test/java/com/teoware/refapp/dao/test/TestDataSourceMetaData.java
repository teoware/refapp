...
public final class TestDataSourceMetaData {
	...
	public static final String CREATE_TABLE_USER_INFO_STATEMENT = "CREATE TABLE REFAPP.USER_INFO ("
			+ "ID BIGINT GENERATED ALWAYS AS IDENTITY (START WITH 1, INCREMENT BY 1) NOT NULL, "
	...
	public static final String CREATE_TRIGGER_USER_INFO_TRG1_STATEMENT = "CREATE TRIGGER REFAPP.USER_INFO_TRG1 "
			+ "AFTER UPDATE ON REFAPP.USER_INFO REFERENCING OLD ROW AS OLDROW FOR EACH ROW BEGIN ATOMIC "
