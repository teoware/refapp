...
public final class TestDataSourceMetaData {
	...
	public static final String CREATE_TABLE_REF_USERS_STATUS_STATEMENT = "CREATE TABLE REFAPP.REF_USERS_STATUS ("
	...
	public static final String CREATE_TABLE_USERS_STATUS_STATEMENT = "CREATE TABLE REFAPP.USERS_STATUS ("
	...
	public static final String CREATE_TABLE_USERS_PASSWORD_STATEMENT = "CREATE TABLE REFAPP.USERS_PASSWORD ("
			+ "USERNAME VARCHAR(20) NOT NULL, "
	...
	public static final String CREATE_TABLE_USERS_ADDRESS_STATEMENT = "CREATE TABLE REFAPP.USERS_ADDRESS ("
			+ "USERNAME VARCHAR(20) NOT NULL, "
			+ "ADDRESS VARCHAR(50), "
	...
	public static final String CREATE_TRIGGER_USERS_TRG2_STATEMENT = "CREATE TRIGGER REFAPP.USERS_TRG2 "
			...
			+ "UPDATE REFAPP.USERS_STATUS SET MODIFIED = CURRENT_TIMESTAMP WHERE USERNAME = OLDROW.USERNAME; END";

	public static final String INSERT_REF_USERS_STATUS_STATEMENT_1 = "INSERT INTO REFAPP.REF_USERS_STATUS "
			+ "VALUES ('PENDING', 'User is pending activation')";

	public static final String INSERT_REF_USERS_STATUS_STATEMENT_2 = "INSERT INTO REFAPP.REF_USERS_STATUS "
			+ "VALUES ('ACTIVE', 'User is active')";

	public static final String INSERT_REF_USERS_STATUS_STATEMENT_3 = "INSERT INTO REFAPP.REF_USERS_STATUS "
			+ "VALUES ('SUSPENDED', 'User is suspended')";

	public static final String INSERT_REF_USERS_STATUS_STATEMENT_4 = "INSERT INTO REFAPP.REF_USERS_STATUS "
