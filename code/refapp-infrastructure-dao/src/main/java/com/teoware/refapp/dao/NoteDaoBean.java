...
public class NoteDaoBean extends Dao implements NoteDao {
	...
	public CreateNoteOutput createNote(CreateNoteInput input) throws DaoException {
		...
		Object[] parameters = DaoHelper.generateArray(input.getUserId(), input.getTitle());
	...
	public ReadNoteOutput readNote(ReadNoteInput input) throws DaoException {
		...
		Object[] parameters = DaoHelper.generateArray(input.getTitle());
	...
	public UpdateNoteOutput updateNote(UpdateNoteInput input) throws DaoException {
		...
		if (input.getTitle() != null) {
			SQL sql = new SQL.Builder().doUpdate(NOTES_TABLE).setColumn(TITLE_COLUMN_NAME).where(ID_COLUMN_NAME)
					.build();
			Object[] parameters = DaoHelper.generateArray(input.getTitle(), input.getId());
