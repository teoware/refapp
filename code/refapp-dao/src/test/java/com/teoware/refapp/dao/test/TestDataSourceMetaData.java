...
public final class TestDataSourceMetaData {
	...
	public static final String CREATE_TRIGGER_AUTHORS_TRG01_STATEMENT = "CREATE TRIGGER REFAPP.AUTHORS_TRG01 "
			+ "AFTER INSERT ON REFAPP.AUTHORS REFERENCING NEW ROW AS NEWROW FOR EACH ROW BEGIN ATOMIC "
	...
	public static final String CREATE_TRIGGER_AUTHORS_TRG02_STATEMENT = "CREATE TRIGGER REFAPP.AUTHORS_TRG02 "
			+ "AFTER UPDATE ON REFAPP.AUTHORS REFERENCING OLD ROW AS OLDROW FOR EACH ROW BEGIN ATOMIC "
			+ "UPDATE REFAPP.AUTHORS_STATUS SET MODIFIED = CURRENT_TIMESTAMP WHERE AUTHOR = OLDROW.USERNAME; END";
