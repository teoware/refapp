...
public class UserDaoBeanTest {
    ...
    public void testReadUserJohn() throws Exception {
        ResultSet localResultSet = TestResultSetFactory.createReadUserJohnResultSet();
    ...
    public void testReadUserIdJohn() throws Exception {
        ResultSet localResultSet = TestResultSetFactory.createReadUserIdJohnResultSet();
    ...
    public void testReadAllUsers() throws Exception {
        ResultSet localResultSet = TestResultSetFactory.createReadAllUsersResultSet();
    ...
    public void testReadUserPasswordJohn() throws Exception {
        ResultSet localResultSet = TestResultSetFactory.createReadUserPasswordJohnResultSet();
