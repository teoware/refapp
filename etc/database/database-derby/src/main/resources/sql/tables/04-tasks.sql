...
(
	...
	CONSTRAINT TASKS_STATUS_FK1	FOREIGN KEY (TASK_ID) REFERENCES REFAPP.TASKS (ID),
	CONSTRAINT TASKS_STATUS_FK2	FOREIGN KEY (STATUS) REFERENCES REFAPP.REF_TASKS_STATUS (STATUS),
